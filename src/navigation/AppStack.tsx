...
export function AppStack() {
  ...
  return (
    <Stack.Navigator
      ...
      <Stack.Screen name="StorageManagement" component={StorageManagementScreen} options={{ title: 'Quản lý dung lượng' }} />
      <Stack.Screen name="HighSecurity" component={HighSecurityScreen} options={{ title: 'Bảo mật cao' }} />
    </Stack.Navigator>
  );
}
